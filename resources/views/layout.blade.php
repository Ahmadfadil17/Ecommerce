...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
        <div class="container">
          <a class="navbar-brand fw-bold" href="#">DyLz Shop Game</a>
    ...
    <div class="container py-3 mt-5">
        <img class="card-img-top" width="100" height="330" src="img/bg.ff.jpg" alt="">
    </div>
                ...
                <div class="col mb-5">
                    <div class="card h-100">
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center"><a class="btn btn-outline-primary mt-auto" href="/viewop/{{ $item->id }}">View options</a></div>
                        </div>
                    </div>
                </div>
                @endforeach
